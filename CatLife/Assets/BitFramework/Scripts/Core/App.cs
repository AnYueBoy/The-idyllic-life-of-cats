...
namespace BitFramework.Core
{
    public class App
    {
        ...
        #region TypeConvertToService

        public static string TypeConvertToService(Type type)
        {
            return That.TypeConvertToService(type);
        }

        public static string TypeConvertToService<TService>()
        {
            return That.TypeConvertToService<TService>();
        }
